# Contributing to harn-bitbucket-connector

This repository does not accept external contributions.

## Why

`harn-bitbucket-connector` is a generated and fleet-managed connector package. It carries the
Bitbucket side of the Harn connector contract and almost nothing else. Its
...
- Found a bug in how this connector handles Bitbucket, or want a connector that
